...
```
**DIEPKL**: there is an extra code in the dataset ("> 6 m") and the ordering of the levels could be more logical
...
```
**FUNCTIE**: the code "veedrenk" is not mentioned in the report and there are many more codes in the report than in the dataset
