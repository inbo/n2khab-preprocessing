...
### Encoding problems (still to do) 

We will need to correct some encoding problems, as shown in the examples hereunder:
...
(please note "≥" in ws_11$DIEPKL are rendered as "=" in the html output) 
...
Here are the categories (source: metadata report) for:
