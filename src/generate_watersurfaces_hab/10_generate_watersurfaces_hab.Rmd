...
hashes <-
    ...
    mutate(filename = basename(filepath),
           ...
           mutate(md5_ref = c("29ac23d878ad9ec337699d3c88ae45b0"),
           match = md5 == md5_ref) %>%
    select(filename,
           md5,
           md5_ref,
...
In previous versions (until v1.0) the watersurface map did not have an attribute that contained a unique id. Since v1.1 the WVLC attribute is unique and can be used as identifier. 
