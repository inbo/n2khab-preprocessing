...
hashes <-
    ...
    mutate(filename = basename(filepath),
           ...
           mutate(md5_ref = c("6cc9dc73f316fbaa353fe11ff33f3359"), # version 2024 v99_interim
           match = md5 == md5_ref) %>%
    select(filename,
           md5,
           md5_ref,
