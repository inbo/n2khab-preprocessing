...
hashes <-
  ...
  mutate(
    md5_ref = c("e7d9930938f5111de33de6ecaec31a66"),
    match = md5 == md5_ref
  ) %>%
  select(
    filename,
...
(pol_v5 <- read_sf(filepath_v5, layer = "watersurfaces_hab_polygons"))
(types_v5 <- read_sf(filepath_v5, layer = "watersurfaces_hab_types"))
```
