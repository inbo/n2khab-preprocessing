...
hashes <-
  ...
  mutate(
    ...
    md5_ref = c("b7a3e688be3a428885971ff423cbc683"),
    match = md5 == md5_ref
  ) %>%
  select(
    filename,
...
In some cases we'll need to refer to the source-map (from [Zenodo](https://doi.org/10.5281/zenodo.3354381)).

Again we will check if it is the correct version (habitatmap_2025).
