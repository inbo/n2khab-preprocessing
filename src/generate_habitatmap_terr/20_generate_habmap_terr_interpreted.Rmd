...
hashes <-
    ...
    mutate(filename = str_match(filepath, "(.+\\/)*(.+)")[,3],
           ...
           md5_ref = c("28196670db9c9aa3bee581a775c1a9d4"),
           match = md5 == md5_ref) %>%
    select(filename,
           md5,
           md5_ref,
...
# data source version habitatmap_stdized_2020_v1:
