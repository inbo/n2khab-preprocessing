...
hashes <-
    ...
    mutate(filename = str_match(filepath, "(.+\\/)*(.+)")[,3],
           ...
           md5_ref = c("95305aae46689afebcc1f3dc02b92be1"),
           match = md5 == md5_ref) %>%
    select(filename,
           md5,
           md5_ref,
...
Again we will check if it is the correct version (habitatmap_2025_interim).
