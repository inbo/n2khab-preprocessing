...
Illustration of failure of the `calc()` approach. It makes me wonder: is there a bug in my code or in `raster::calc()`...
I guess `raster::calc()` doesn't cope so well with NA's.
