...
To be sure we will use the correct version of the data source (habitatmap_2023), we will derive the md5 file checksums and compare it to the file checksums in the [data source version overview table](https://docs.google.com/spreadsheets/d/1E8ERlfYwP3OjluL8d7_4rR1W34ka4LRCE35JTxf3WMI/edit#gid=2100595853).

Since no reference checksum exists for the 2025 version of the N2habmap, the MD5 checksum is being calculated for the file for future usage. The resulting checksum should be added to the reference list.
