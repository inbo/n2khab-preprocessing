...
write_vc(habmap_correction,  "data/habmap_correction",
         sorting = "code")
...
habmap_correction <- read_vc("data/habmap_correction")
...
habmap_types <- habmap_long %>%
  filter(!is.na(typelevel)) %>%
   select(polygon_id, patch_id, code_orig = code, phab, uncertain, type) %>%
...
st_write(habmap_types_sf, "../../data/20_processed/habitatmap_stdized/habitatmap_stdized.gpkg", layer = "habitatmap_polygons", driver = "GPKG")

con = dbConnect(SQLite(),
                dbname = "../../data/20_processed/habitatmap_stdized/habitatmap_stdized.gpkg")
